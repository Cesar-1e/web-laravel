<div class="mb-4">
    ...
    <input type="text" name="title" class="w-full p-2 border border-gray-700 rounded-md" value="{{ old('title', $blog->title ?? '') }}" />
...
<div class="mb-4">
    ...
    <select name="category_id" class="w-full p-2 border border-gray-700 rounded-md appearance-none">
        ...
        <option 
        value="{{ $category->id }}"
        @if ($category->id == old('category_id', $blog->category_id ?? null)) selected @endif
...
<div class="mb-4">
    ...
    <textarea name="content" rows="6" class="w-full p-2 border border-gray-700 rounded-md">{{ old('content', $blog->content ?? '') }}</textarea>
